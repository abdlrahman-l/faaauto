    ...
    return (
        <section className='mt-10 min-h-screen flex items-center justify-center flex-col px-10 space-y-4'>
            ...
            <div className='max-w-[600px] space-y-5 lg:space-y-10'>
                <h1 className='font-bold text-2xl lg:text-4xl text-center'>Mitra Leasing <strong className='text-blue-700'>Terpercaya</strong> Kami</h1>
                <p className='text-center text-gray-500'>Kami hanya bekerja sama dengan perusahaan leasing dan multifinance ternama yang <strong className='text-blue-700'>terdaftar</strong> dan diawasi <strong className='text-red-700'>OJK</strong>. Ini memastikan keamanan dan legalitas setiap transaksi Anda, serta akses ke penawaran terbaik.</p>
            </div>
