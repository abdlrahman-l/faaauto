...
export default function HorizontalTimeline() {
    return (
        <section className="py-24 lg:py-36 h-full flex flex-col items-center justify-center space-y-6 lg:space-y-14 relative" id="process-banner">
            ...
            <h1 className="text-2xl lg:text-3xl text-gray-700 text-center font-bold px-5">Bagaimana Kami <strong className="text-blue-900">Membantu</strong> Anda</h1>
                    ...
                    {timelineItems.map((item, index) => (
                        <div key={index} className="flex flex-col lg:flex-row items-center">
                            ...
                            <div className="relative flex flex-col items-center">
                                <div className="z-10 bg-blue-900 p-5 rounded-full shadow-md">
                                    {item.icon}
                                </div>
                            </div>
